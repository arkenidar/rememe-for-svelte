...
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"Memory Game Tutorial","description":"A beginner-friendly introduction to web development with Vite and Svelte, built around a Memory game.","base":"/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"nav":[{"text":"Home","link":"/"},{"text":"Game Code","link":"https://github.com/arkenidar/rememe-for-svelte"}],"sidebar":[{"text":"Getting Started","items":[{"text":"Introduction","link":"/01-introduction"},{"text":"Setup & Tooling","link":"/02-setup-and-tooling"},{"text":"Project Structure","link":"/03-project-structure"}]},{"text":"Svelte & the Game","items":[{"text":"Svelte Basics","link":"/04-svelte-basics"},{"text":"Memory Game Walkthrough","link":"/05-memory-game-walkthrough"},{"text":"Extending the Game","link":"/06-extending-the-game"}]},{"text":"Reference","items":[{"text":"Glossary & Links","link":"/07-glossary-and-links"}]}],"socialLinks":[{"icon":"github","link":"https://github.com/arkenidar/rememe-for-svelte"}],"outline":{"level":[2,3]},"footer":{"message":"A beginner-friendly Vite + Svelte tutorial.","copyright":"MIT Licensed"}},"locales":{},"scrollOffset":134,"cleanUrls":true}'));
